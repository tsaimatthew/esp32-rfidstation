...
## Remote Configuration Options available via web interface
- Set client and server certificates to send data over BLE
- Change device name
- Enable/disable OTA updates
- Enable/disable BLE (should be disabled after initial configuration)
- Change sample rate of sensor (default 5 minute)
- Change WiFi credentials
- If WiFi disconnected, default back to broadcasting BLE 
...
### Sensors
This provides the functions to read the sensors via SPI. It has the firmware for the BME280 It also contains the MQTT functions responsible for sending the bundled MQTT periodically.